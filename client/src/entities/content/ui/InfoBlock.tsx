        ...
        <Container as="section" className="mb-5 pb-5" id={id}> 
            <Row xs={1} md={2} className="g-4">
                <Col>
                    ...
                    <div className="w-100 ">
                    <video
                        src="/memorial/about.mov"
                        autoPlay
                        muted
                        loop
                        style={{width:'100%', height:'850px'}}
                        className="object-fit-cover rounded-5 ratio-16x9 w-100"/>
                    </div>
                ...
                <Col>
                    <div className="bg-body-tertiary rounded-5 py-5 px-4 px-sm-5 h-100">
                        <div className="py-md-3 py-lg-4 py-xl-5 px-lg-4 px-xl-5 my-lg-2 my-xl-4 my-xxl-5 h-100">
