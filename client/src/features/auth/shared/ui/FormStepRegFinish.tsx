...
const FormStepRegFinish = ({disabled=false}:Props) => {
    const t = useTranslations();
    const { setShowOffAuth } = useAuth();
    return (
        <div className="text-center p-2">
            <i className="ci-user-check mb-4" style={{fontSize:48}}/>
            <h3 className="mb-5">{t('auth.registerSuccess')}</h3>
...
export default FormStepRegFinish;